...
const bodyFitStyles = {
    normal_fit_body:
        "front/fit_loose%2Bbutton_close_standard%2Binside.png",
...
async function run() {
    console.log("🚀 Downloading men shirt body fit styles...\n");
    ...
    for (const [fabricKey, fabricName] of Object.entries(fabrics)) {
        ...
        for (const [fileName, filePath] of Object.entries(bodyFitStyles)) {
        ...
        console.log(
            `🎉 ${successCount}/${Object.keys(bodyFitStyles).length} body fit styles downloaded for ${fabricName}`
        );
    }

    console.log(
        "\n✅ All men shirt body fit style downloads completed!"
    );
}
