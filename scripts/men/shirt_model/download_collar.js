...
// Final structure:
// public/assets/men/shirt/{fabric_name}/style/{file}.png

const collarStyles = {
    col_new_kent:
        "front/necklines_open%2Bbutton_close_standard%2Bopen.png",

    col_cutaway:
        "front/necklines_open_extreme%2Bbutton_close_standard%2Bopen.png",

    col_kent_collar:
        "front/necklines_classic%2Bbutton_close_standard%2Bopen.png",

    col_button_down:
        "front/necklines_buttons%2Bbutton_close_standard%2Bopen.png",

    col_rounded_collar:
        "front/necklines_lady%2Bbutton_close_standard%2Bopen.png",

    col_stand_up_collar:
        "front/necklines_mao%2Bbutton_close_standard%2Bopen.png",
};
...
async function run() {
    console.log("🚀 Downloading men shirt collar styles...\n");
    ...
    for (const [fabricKey, fabricName] of Object.entries(fabrics)) {
        ...
        console.log(
            `🎉 ${successCount}/${Object.keys(collarStyles).length} collar styles downloaded for ${fabricName}`
        );
    }

    console.log(
        "\n✅ All men shirt collar style downloads completed!"
    );
}
