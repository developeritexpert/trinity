                ...
                <nav className="hidden lg:flex items-center gap-8">
                    ...
                    <div className="relative group/shop py-4">
                        ...
                        <div className="absolute top-full left-0 mt-0 w-52 bg-white border border-gray-100 shadow-xl rounded-md py-2 opacity-0 invisible group-hover/shop:opacity-100 group-hover/shop:visible transition-all duration-200 z-50">
                            <Link href="/men/blazer-api" className="block px-4 py-2.5 text-[11px] font-semibold uppercase tracking-wider text-slate-700 hover:bg-slate-50 hover:text-[#0066FF] transition-colors">
                            ...
                            <Link href="/men/model-shirt" className="block px-4 py-2.5 text-[11px] font-semibold uppercase tracking-wider text-slate-700 hover:bg-slate-50 hover:text-[#0066FF] transition-colors">
                                Men's Custom Shirts
                            </Link>
